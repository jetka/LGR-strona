                ...
                <AnimatePresence>
                    {selectedImage !== null && (
                        <motion.div
                            ...
                            animate={{ opacity: 1 }}
                            exit={{ opacity: 0 }}
                            className="fixed inset-0 z-[200] flex flex-col justify-center items-center bg-[#050505]/fb backdrop-blur-xl"
                        ...
                        >
                            ...
                            <div className="relative w-full max-w-6xl h-[70vh] flex items-center justify-center p-4">
                                ...
                                <motion.div
                                    ...
                                    className="bg-[#fdfdfd] p-3 pb-6 rounded-sm shadow-[0_30px_70px_rgba(0,0,0,0.7)] flex flex-col items-center max-w-[95vw] max-h-[85vh] z-30 cursor-grab active:cursor-grabbing touch-none"
                                ...
                                >
                                    ...
                                    />
                                    <div className="mt-2 text-black/50 font-black text-[10px] uppercase tracking-[0.4em] italic select-none">
                                        #LGRTEAM
                                    </div>
                                </motion.div>
                            ...
                            {/* Bottom Thumbnails */}
                            <div className="absolute bottom-5 hidden md:flex gap-4 z-40" onClick={(e) => e.stopPropagation()}>
                                {images.map((src: string, i: number) => (
                                    <div
                                        key={i}
                                        onClick={() => setSelectedImage(i)}
                                        className={`relative w-14 h-14 rounded-lg overflow-hidden cursor-pointer transition-all border-2 flex-shrink-0 ${i === selectedImage ? 'border-[var(--color-lgr-red)] scale-105 opacity-100' : 'border-white/10 opacity-30 hover:opacity-100 hover:scale-105'}`}
                                    >
                                        <Image src={src} alt="Miniatura" fill unoptimized className="object-cover" sizes="48px" />
                                    </div>
                                ))}
                            </div>
                        </motion.div>
